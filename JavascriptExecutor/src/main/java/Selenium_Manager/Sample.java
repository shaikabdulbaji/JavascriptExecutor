...
public static void main(String[] args)  {
		 ...
		 * In previous days like selnium 3 for opening chrome browser we use to store chrome driver
		   ...
		   "To overcome this problem some third party members have introduced some dependencies like
		    ...
		    for this we can't use  "WebDriverManager.chromedriver().setup();" this statement.
		    we diretly use this statement   "WebDriver driver = new ChromeDriver();"
		    
		    Note :
		    * For good practice we have to maintain "Selenium Java and Selenium Manager as same versions"
